...
def main(input_directory, output_directory, margin=80, dpi=1200):
    ...
    #Calculate the dimensions of a card in pixels based on the DPI
    ...
    for image in images:
        #Does this exceed with of paper?
        if current_col + 1 > 3:
            current_row += 1
            current_col = 0
...
if __name__ == "__main__":
    input_directory = r"PUT YOUR INPUT DIRECTORY HERE"
    output_directory = r"PUT YOUR OUTPUT DIRECTORY HERE"
